...
import ArticleQuizSession from "./ArticleQuizSession";

export default function ArticleTrainer({ words }: { words: Word[] }) {
  ...
  return (
    <div>
      ...
      <ArticleQuizSession key={activeCategory} pool={pool} storageKey={activeCategory} />
    </div>
  );
}
